...
ode_results = os.path.join(os.getcwd(), r"results_RK51", r"dt_0.05", r"triangle")
fe_results = os.path.join(os.getcwd(), "resultsViscoTimeSteps_no_mu1")
